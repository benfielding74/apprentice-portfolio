---
title: "Release 0"
categories: [profession in context, continuous learning and development, organisational culture]
...
I work within the HackIT team who are a DevOps team that build and support the infrastructure for products and projects on the Universal Credit platform. We work closely with the feature teams in Leeds and Manchester and aspire to work in a way that increases the flow of value from a Developer writing code through to the end user. DevOps culture encourages this collaborative approach, emphasising communication, integration and automation between these Developer feature teams and our Operations team. Our team charter below in figure 1 highlights some of the principles of DevOps culture that we demonstrate in our team such as collaborating and sharing knowledge within the team and the Dev Teams that we support and being accountable for the work we do. My team also demonstrate values that underpin a DevOps culture by using automation to increase efficiency, and accelerate the delivery process, implementing CI/CD pipelines and regularly gathering feedback from the Developer teams we support in order to improve our service and platform. This means we are agile in responding requests and comments and implementing changes, which is evidenced in the teams's work backlog and in the Developer support Slack channel. There can be some disadvantages in working in this manner too. Being responsive to feedback and developer requests can lead to a high volume of work if not managed correctly with the risk of burnout and not being able to service each team's requests in a timely manner. This pace of work coupled with automation can also carry a risk of introducing security vulnerabilities if work is rushed out without adequate checks or safety steps in pipelines or scripts. There is also a risk that the team could become more activity driven than outcome driven. [(*K9*)]({{< ref "/posts/work-mapping-table#K9" >}})
